...
class MappingTable(QWidget):
    ...
    def __init__(self, store: MappingStore):
        ...
        ctrl_hold_btn = QPushButton("Ctrl 30s + Arrow 0.3s Hold")
        ctrl_hold_btn.clicked.connect(lambda: self.preset_requested.emit("ctrl_hold_arrow_tap"))
        btn_layout.addWidget(ctrl_hold_btn)
